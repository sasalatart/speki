Meteor.methods({
  addAnswer: (questionID, courseID, text) => {
    ...
    return { header: new Date().toLocaleString(), text: 'Respuesta agregada.' }
  },
  updateAnswer: (answerID, text) => {
    ...
    return { header: new Date().toLocaleString(), text: 'Respuesta editada.' }
  },
  removeAnswer: answerID => {
    ...
    return { header: new Date().toLocaleString(), text: 'Respuesta eliminada.' }
  },
  agree: answerID => {
    check(answerID, String);
    checkLoggedIn();

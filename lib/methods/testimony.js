Meteor.methods({
  addTestimony: (courseID, text) => {
    ...
    return { header: new Date().toLocaleString(), text: 'Testimonio agregado.' }
  },
  updateTestimony: (testimonyID, text) => {
    ...
    return { header: new Date().toLocaleString(), text: 'Testimonio editado.' }
  },
  removeTestimony: testimonyID => {
    ...
    return { header: new Date().toLocaleString(), text: 'Testimonio eliminado.' }
  }
});
